					...
					<div className="fixed inset-0 overflow-y-auto">
						<div className="min-h-full items-center justify-center p-4 text-center">
							...
							>
								<Dialog.Panel
									className={
										'relative w-full max-w-lg max-h-[90vh] overflow-y-auto mx-auto transform rounded-2xl p-6 bg-white text-left shadow-xl transition-all flex flex-col gap-5'
									}
								>
									<button
										className="absolute top-2 right-2 z-10 w-fit p-2 bg-primary-blue-100 rounded-xl"
										type="button"
										onClick={closeModal}
									>
